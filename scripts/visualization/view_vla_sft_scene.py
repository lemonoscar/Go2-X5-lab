...
使用方法:
    ...
    python scripts/visualization/view_vla_sft_scene.py --scene_type a2_table_grasp --live
    python scripts/visualization/view_vla_sft_scene.py --scene_type a3_simple_clutter --num_clutter 5
    python scripts/visualization/view_vla_sft_scene.py --scene_type a4_multi_height_table_clutter
"""
