...
使用方法:
    python scripts/tools/view_vla_sft_mobile_scene.py --scene_type b1_open_floor
    python scripts/tools/view_vla_sft_mobile_scene.py --scene_type b2_table_approach --live
    python scripts/tools/view_vla_sft_mobile_scene.py --scene_type b3_obstacle_avoidance --num_obstacles 3
    python scripts/tools/view_vla_sft_mobile_scene.py --scene_type b4_partial_occlusion
"""
