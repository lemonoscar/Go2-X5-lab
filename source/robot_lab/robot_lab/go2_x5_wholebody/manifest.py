...
def _validate_contract(manifest: dict[str, Any]) -> None:
    expected = {
        ...
        "runtime.physics.solver_type": "TGS",
        "runtime.physics.solver_position_iterations": 8,
        "runtime.physics.solver_velocity_iterations": 1,
        "runtime.physics.contact_offset_m": 0.01,
        "runtime.physics.rest_offset_m": 0.0,
        "runtime.physics.bounce_threshold_velocity_m_s": 0.5,
        "runtime.physics.max_depenetration_velocity_m_s": 1.0,
        "runtime.physics.static_friction": 1.0,
        "runtime.physics.dynamic_friction": 1.0,
        "runtime.physics.restitution": 0.0,
        ...
        "runtime.ik_position_drive.profile": "roboduet_go2_x5_ik_v1",
        "runtime.ik_position_drive.stiffness": [10000.0, 10000.0, 10000.0, 4000.0, 2000.0, 1000.0],
        "runtime.ik_position_drive.damping": [140.0, 140.0, 140.0, 70.0, 42.0, 28.0],
        "runtime.ik_position_drive.effort": [20.0, 20.0, 15.0, 7.0, 5.0, 5.0],
        "runtime.ik_position_drive.velocity": 3.0,
