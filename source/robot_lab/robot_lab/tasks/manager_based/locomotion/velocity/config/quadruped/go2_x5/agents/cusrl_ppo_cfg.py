...
@dataclass
class Go2X5RoughTrainerCfg(TrainerCfg):
...
@dataclass
class Go2X5FlatTrainerCfg(Go2X5RoughTrainerCfg):
    max_iterations = 5000
    experiment_name = "go2_x5_flat"


@dataclass
class Go2X5FoundationFlatTrainerCfg(Go2X5RoughTrainerCfg):
    max_iterations = 8000
    save_interval = 100
    experiment_name = "go2_x5_foundation_flat"


@dataclass
class Go2X5ArmUnlockFlatTrainerCfg(Go2X5RoughTrainerCfg):
    max_iterations = 5000
    save_interval = 100
    ...
    agent_factory = cusrl.ActorCritic.Factory(
        ...
        optimizer_factory=cusrl.OptimizerFactory("AdamW", defaults={"lr": 5.0e-4}),
        sampler=cusrl.AutoMiniBatchSampler(num_epochs=5, num_mini_batches=4),
        hooks=[
            cusrl.hook.ValueComputation(),
            cusrl.hook.GeneralizedAdvantageEstimation(gamma=0.99, lamda=0.95),
            ...
            cusrl.hook.OnPolicyPreparation(),
            cusrl.hook.PpoSurrogateLoss(),
            cusrl.hook.EntropyLoss(weight=0.003),
            cusrl.hook.GradientClipping(max_grad_norm=1.0),
            cusrl.hook.OnPolicyStatistics(sampler=cusrl.AutoMiniBatchSampler()),
            cusrl.hook.AdaptiveLRSchedule(desired_kl_divergence=0.01),
        ],
...
@dataclass
class Go2X5ArmLocomotionFlatTrainerCfg(Go2X5RoughTrainerCfg):
    max_iterations = 6000
    save_interval = 100
    ...
    agent_factory = cusrl.ActorCritic.Factory(
        ...
        optimizer_factory=cusrl.OptimizerFactory("AdamW", defaults={"lr": 2.0e-4}),
        sampler=cusrl.AutoMiniBatchSampler(num_epochs=5, num_mini_batches=4),
        hooks=[
            cusrl.hook.ValueComputation(),
            cusrl.hook.GeneralizedAdvantageEstimation(gamma=0.99, lamda=0.95),
            ...
            cusrl.hook.OnPolicyPreparation(),
            cusrl.hook.PpoSurrogateLoss(),
            cusrl.hook.EntropyLoss(weight=0.0025),
            cusrl.hook.GradientClipping(max_grad_norm=1.0),
            cusrl.hook.OnPolicyStatistics(sampler=cusrl.AutoMiniBatchSampler()),
            cusrl.hook.AdaptiveLRSchedule(desired_kl_divergence=0.01),
        ],
...
@dataclass
class Go2X5DogOnlyFlatTrainerCfg(Go2X5RoughTrainerCfg):
    max_iterations = 6000
    save_interval = 100
    experiment_name = "go2_x5_dog_only_flat"
...
@dataclass
class Go2X5DogOnlyArmFlatTrainerCfg(Go2X5DogOnlyFlatTrainerCfg):
    max_iterations = 6000
    save_interval = 100
    experiment_name = "go2_x5_dog_only_arm_flat"


@dataclass
class Go2X5DogOnlyRecoverFlatTrainerCfg(Go2X5DogOnlyFlatTrainerCfg):
    max_iterations = 4000
    save_interval = 100
    experiment_name = "go2_x5_dog_only_recover_flat"
    ...
    agent_factory = cusrl.ActorCritic.Factory(
        ...
        optimizer_factory=cusrl.OptimizerFactory("AdamW", defaults={"lr": 1.0e-4}),
        sampler=cusrl.AutoMiniBatchSampler(num_epochs=5, num_mini_batches=4),
        hooks=[
            cusrl.hook.ValueComputation(),
            cusrl.hook.GeneralizedAdvantageEstimation(gamma=0.99, lamda=0.95),
            ...
            cusrl.hook.OnPolicyPreparation(),
            cusrl.hook.PpoSurrogateLoss(),
            cusrl.hook.EntropyLoss(weight=0.0015),
            cusrl.hook.GradientClipping(max_grad_norm=1.0),
            cusrl.hook.OnPolicyStatistics(sampler=cusrl.AutoMiniBatchSampler()),
            cusrl.hook.AdaptiveLRSchedule(desired_kl_divergence=0.01),
        ],
...
@dataclass
class Go2X5DogOnlyHardRoughTrainerCfg(Go2X5DogOnlyRoughTrainerCfg):
    max_iterations = 18000
    save_interval = 100
    experiment_name = "go2_x5_dog_only_hard_rough"
...
class Go2X5RobustRoughTrainerCfg(Go2X5RoughTrainerCfg):
    ...
    save_interval = 100
    experiment_name = "go2_x5_robust_rough"
