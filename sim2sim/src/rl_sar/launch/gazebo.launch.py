...
def generate_launch_description():
    ...
    wname = "stairs"
    system_python_path = "/usr/bin:" + os.environ.get("PATH", "")
    ...
    return LaunchDescription([
        ...
        # gazebo_ros/spawn_entity.py uses /usr/bin/env python3. Keep it on the
        # ROS system Python even when a conda environment is active.
        SetEnvironmentVariable("PATH", system_python_path),
